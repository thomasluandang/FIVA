...
d3.chart.bullet = function() {
  ...
  function bullet(g) {
    g.each(function(d, i) {
	  ...
	  rangeArray.push(ranges.call(this, d, i));
	  
	  var measureArray = new Array();
	  measureArray.push(measures.call(this, d, i));
	  
	 // document.writeln(ranges.call(this, d, i));
	 // document.writeln(markers.call(this, d, i));
	  
	  var markerArray = [130000, 0];

      var rangez = rangeArray.slice().sort(d3.descending),
          markerz = markerArray.slice().sort(d3.descending),
          measurez = measureArray.slice().sort(d3.descending), // TODO: FIVA custom, should actually be 2 values, the max range of the chart, and the previous goal (or previous goal and holding)
          g = d3.select(this);
...
function d3_chart_bulletMarkers(d) {
  return d.holdings; // TODO: unused in FIVA for now
}
