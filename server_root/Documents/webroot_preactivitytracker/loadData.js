...
function readClientList ()
{
	...
	d3.json("data/clientlist.json", function (json) {
			gClientList = json;
		}
	);
}
...
function populateAccountSelect(client) {
	...
	// reset selected index to 0 to avoid strange things
...
function accountSelectOnChange() {
	var AccountSelect =  document.getElementById("AccountSelect");
	var ClientSelect =  document.getElementById("ClientSelect");
...
function updateStartEndYearHelper (accountData) {
	var startYearInAccount = accountData[0]["year"]; // TODO: confusion and redundancy in naming, refactor
	...
	// TODO: Logic may change later, some stuff currently redundant
...
function treemapZoomOutOnClick () {
