    ...
    g.each(function(d, i) {
	 ...
	 // document.writeln(markers.call(this, d, i));
      ...
      var rangez = rangeArray.slice().sort(d3.descending),
          ...
          measurez = measureArray.slice().sort(d3.descending), // TODO: FIVA hack, should actually be 2 values, the max range of the chart, and the previous goal (or previous goal and holding)
          g = d3.select(this);
